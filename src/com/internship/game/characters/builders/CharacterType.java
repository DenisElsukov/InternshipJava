...
public enum CharacterType {
    WIZARD ("I think, you done rightly choice", "'I'm too old for this shit", "A wizard is never late. He arrives precisely when he means to", "You shall not pass!"), ROGUE("Hello. I stole an apple for you.", "I hop when you blink", "Hop!", "\\'Slit!\\' \\'Crrrr!\\'"), WARRIOR("Greetings! I'm always ready to fight!", "I will do it!", "Only forward!" , "Attack now! I was born to win!");
